...
public:
   ...
   */
  Mux(int8_t selectionPins[], uint8_t selectionPinsLength, int8_t enablePin = UNDEFINED);
  ...
  Mux(uint8_t signalPin, uint8_t signalMode, uint8_t signalType,
      int8_t selectionPins[], uint8_t selectionPinsLength, int8_t enablePin = UNDEFINED);
